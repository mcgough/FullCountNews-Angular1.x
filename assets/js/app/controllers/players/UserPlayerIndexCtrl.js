PlayerTracker.controller("UserPlayerIndexCtrl", [
  "$scope",
  "$resource",
  "$http",
  "UserService",
  ...
  "$mdDialog",
  "$location",
  function($scope, $resource, $http, UserService, $q, $mdDialog, $location) {
    ...
    $scope.loadUserList = function() {
      ...
      $http.get("/api/userlist/updateUserlistStats").then(
        function(response) {
        ...
        $http
          ...
          .success(function(response) {
            var player = response,
              user = new Player();
            user.$save(
              { userId: $scope.currentUser.id, player: player },
              function(response) {
    ...
    $scope.deletePlayer = function(playerId) {
      $http
        .delete("/api/userlist/deletePlayer", { params: { id: playerId } })
